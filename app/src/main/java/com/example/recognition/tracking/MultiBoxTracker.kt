...
==============================================================================*/
package com.example.recognition.tracking
...
class MultiBoxTracker(context: Context) {
    ...
    @Synchronized
    fun trackResults(
        results: List<SimilarityClassifier.Recognition>,
        timestamp: Long
    ) {
    ...
    private fun processResults(results: List<SimilarityClassifier.Recognition>) {
        val rectsToTrack: MutableList<Pair<Float, SimilarityClassifier.Recognition>> = LinkedList()
        screenRects.clear()
        ...
        for (result in results) {
            ...
            rectsToTrack.add(Pair<Float, SimilarityClassifier.Recognition>(result.distance, result))
        }
